    ...
    <div className="bg-[#FAF8F2] text-[#13251F] min-h-screen select-none">
      ...
      <div className="relative w-full bg-[#071A16] text-white pt-24 sm:pt-36 pb-8 sm:pb-16 min-h-[400px] sm:min-h-[560px] lg:min-h-[610px] flex flex-col justify-center px-4 sm:px-6 lg:px-12 overflow-hidden shadow-2xl border-b border-white/10 mb-8 sm:mb-12">
        ...
        <div className="max-w-[1440px] w-full mx-auto relative z-10 text-left">
          ...
          {/* Floating Stats Row */}
          <div className="mt-4 sm:mt-8 pt-4 sm:pt-6 border-t border-white/15 flex flex-wrap items-center gap-4 sm:gap-10 text-left">
            <div>
            ...
            {categories.map((cat) => {
              ...
              return (
                <button
                  ...
                  className={`inline-flex items-center gap-1 sm:gap-1.5 px-2.5 sm:px-3.5 py-1 sm:py-2 text-[9.5px] sm:text-xs font-bold uppercase tracking-wider rounded-full transition-all duration-200 border cursor-pointer active:scale-95 ${
                    isSelected
                ...
                >
                  ...
                  <span>{cat.label}</span>
                  <span
                    className={`ml-1 text-[9px] sm:text-[10px] px-1.5 py-0.5 rounded-full font-mono font-semibold ${
                      isSelected
