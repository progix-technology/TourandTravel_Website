...
export const ContactPage = () => {
  ...
  return (
    <div className="bg-[#FAF8F2] min-h-screen text-[#13251F] relative overflow-hidden select-none">
      {/* 1. Ultra-Luxurious Hero Header Section */}
        ...
        <div className="max-w-[1440px] w-full mx-auto relative z-10 text-left">
          ...
          <div className="mt-4 sm:mt-8 pt-3.5 sm:pt-6 border-t border-white/15 flex flex-row flex-wrap items-center gap-2.5 sm:gap-4">
            <a
              ...
              className="inline-flex items-center gap-1.5 sm:gap-2 bg-[#6FCF45] hover:bg-[#5eb937] text-[#071A16] px-4 sm:px-7 py-2 sm:py-3 rounded-full text-[11px] sm:text-xs font-bold uppercase tracking-wider transition-all duration-200 shadow-lg shadow-[#6FCF45]/20 active:scale-95"
            >
            ...
            <a
              ...
              className="inline-flex items-center gap-1.5 sm:gap-2 bg-[#25D366] hover:bg-[#20bd5a] text-white px-4 sm:px-7 py-2 sm:py-3 rounded-full text-[11px] sm:text-xs font-bold uppercase tracking-wider transition-all duration-200 shadow-lg shadow-[#25D366]/20 active:scale-95"
            >
